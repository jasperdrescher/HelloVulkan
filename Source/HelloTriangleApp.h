...
private:
    ...
    {
        imageAvailableSemaphores.resize(myMaxFramesInFlight);
        renderFinishedSemaphores.resize(myMaxFramesInFlight);
        inFlightFences.resize(myMaxFramesInFlight);
...
private:
    ...
    const uint32_t myWidth = 800;
    const uint32_t myHeight = 600;
    const int myMaxFramesInFlight = 2;
